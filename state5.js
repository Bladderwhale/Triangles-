    ...
    create:function(){
     ...
     /*   this.fakeHandle3.events.onInputOver.add(function(){
        ...
        this.btnStart.events.onInputDown.add(function(){
            ...
            if (n==3){this.boolTryAgain = true;this.cross2.alpha = 1; this.texts[2].setStyle({backgroundColor: 'rgba(255, 255, 0,1)'});this.texts[3].setStyle({backgroundColor: 'rgba(255, 255, 0,1)'});this.texts[11].setStyle({backgroundColor: 'rgba(255,255,0,1)'}); this.texts[12].setStyle({backgroundColor: 'rgba(255,255,0,1)'}); this.btnStart.frame = 1; b+=1;}
        }
                                             ,this);
