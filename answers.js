...
function isoscelesTriangleAns(state) {
    ...
    state.pinkbox.drawRect(840,723, 275, 80);
    state.pinkbox.alpha = 1;
    state.isoAns1 = game.add.text(849,728, "An isosceles triangle \nhas two equal sides. ");
   // state.isoAns1.addfontWeight = ('bold',0);
    //state.isoAns1.addFontWeight('bold',0);
    state.isoAns1.addFontWeight('normal',0);
   ...
   // state.isoAns1.fontWeight = 'normal';
    ...
    state.pinkbox1b.drawRect(810,735, 325, 80);
    state.pinkbox1b.alpha = 1;
    state.isoAns1b = game.add.text(815,738, "An isosceles triangle  \nalso has two equal angles. ");
   // state.isoAns1.addfontWeight = ('bold',0);
    //state.isoAns1b.addFontWeight('bold',0);
    state.isoAns1b.addFontWeight('normal',0);
   // state.isoAns1.fontWeight = 'normal';
    state.isoAns1b.align = 'left';
    state.pinkbox1b.endFill();
...
function isoscelesTriangleAns2(state) {
    ...
    state.pinkbox2.drawRect(120,649, 350,80);
    state.pinkbox2.alpha = 1;
    state.isoAns2 = game.add.text(125,653, "This is an isosceles triangle. \nIt has two equal sides.");
    state.isoAns2.fontWeight = 'normal';
    state.isoAns2.align = 'left';
    //state.isoAns2.addFontWeight('bold',0);
    state.isoAns2.addFontWeight('normal',0);
    ...
    state.pinkbox2a.drawRect(930,649, 370,80);
    state.pinkbox2a.alpha = 1;
    state.isoAns2a = game.add.text(935,653,"This is an isosceles triangle.\nIt has two equal sides.");
    state.isoAns2a.fontWeight = 'normal';
    state.isoAns2a.align = 'left';
    //state.isoAns2a.addFontWeight('bold',0);
    state.isoAns2a.addFontWeight('normal',0);
   ...
   // state.isoAns2ai.addFontWeight('bold',0);
    ...
    state.pinkbox2b.drawRect(625,670, 360,80);
    state.pinkbox2b.alpha = 1;
    state.isoAns2b = game.add.text(630,673, "This is an isosceles triangle. \nIt has two equal sides.");
    state.isoAns2b.fontWeight = 'normal';
    state.isoAns2b.align = 'left';
    //state.isoAns2b.addFontWeight('bold',0);
    state.isoAns2b.addFontWeight('normal',0);
    state.pinkbox2b.endFill();
    ...
    state.isoAns2bb = game.add.text(205,673, "This is an isosceles triangle. \nIt has two equal sides. ");
    state.isoAns2bb.fontWeight = 'normal';
    state.isoAns2bb.align = 'left';
  //  state.isoAns2bb.addFontWeight('bold',0);
    state.isoAns2bb.addFontWeight('normal',0);
    state.pinkbox2bb.endFill();
    ...
    state.pinkbox2d.drawRect(200,710, 350,110);
    state.pinkbox2d.alpha = 1;
    state.isoAns2d = game.add.text(205,713, "This is an isosceles triangle. \nIt has two equal sides \nand two equal angles.");
    state.isoAns2d.fontWeight = 'normal';
    state.isoAns2d.align = 'left';
    state.isoAns2d.addFontWeight('normal',0);
    state.pinkbox2d.endFill();
    ...
    state.pinkbox2dd.drawRect(620,710, 350,110);
    state.pinkbox2dd.alpha = 1;
    state.isoAns2dd = game.add.text(625,713, "This is an isosceles triangle. \nIt has two equal sides \nand two equal angles.");
    state.isoAns2dd.fontWeight = 'normal';
    state.isoAns2dd.align = 'left';
    state.isoAns2dd.addFontWeight('normal',0);
    state.pinkbox2dd.endFill();
    ...
    state.pinkbox2ddd.endFill();
    state.isoAns2ddd.alpha = 0;
    state.pinkbox2ddd.alpha = 0;
    ...
    state.pinkbox3.drawRect(590,649,270,80);
    state.pinkbox3.alpha = 1;
    state.isoAns3 = game.add.text(595,653, "All three sides of this  \ntriangle are different.");
    state.isoAns3.fontWeight = 'normal';
    state.isoAns3.align = 'left';
    state.pinkbox3.endFill();
    state.isoAns3.addFontWeight('normal',0);
    state.isoAns3.alpha = 0;
    state.pinkbox3.alpha = 0;
    
    //for state 4 and slides 9 on ppt.
    state.pinkbox3b = game.add.graphics(0,0);
    state.pinkbox3b.beginFill(0xF2C2B5, 1);
    state.pinkbox3b.lineStyle(1, 0x000000,1);
    state.pinkbox3b.drawRect(1050,670,270,80);
    state.pinkbox3b.alpha = 1;
    state.isoAns3b = game.add.text(1055,673, "All three sides of this  \ntriangle are different.");
    state.isoAns3b.fontWeight = 'normal';
    state.isoAns3b.align = 'left';
    state.pinkbox3b.endFill();
    state.isoAns3b.addFontWeight('normal',0);
    state.isoAns3b.alpha = 0;
    state.pinkbox3b.alpha = 0;
    
    //for state 6 
    state.pinkbox3c = game.add.graphics(0,0);
    state.pinkbox3c.beginFill(0xF2C2B5, 1);
    state.pinkbox3c.lineStyle(1, 0x000000,1);
    state.pinkbox3c.drawRect(1040,710,355,45);
    state.pinkbox3c.alpha = 1;
    state.isoAns3c = game.add.text(1045,713, "All three angles are different.");
...
function equilateralTrianglesAns(state) {
    ...
    state.pinkbox1.drawRect(840,723, 280, 80);
    state.pinkbox1.alpha = 1;
    state.isoAns1 = game.add.text(849,730, "An equilateral triangle \nhas three equal sides.");
   // state.isoAns1.addfontWeight = ('bold',0);
    state.isoAns1.addFontWeight('normal',0);
   // state.isoAns1.fontWeight = 'normal';
    state.isoAns1.align = 'left';
    ...
    state.pinkbox2.beginFill(0xF2C2B5, 1);
    state.pinkbox2.lineStyle(1, 0x000000,1);
    state.pinkbox2.drawRect(1000,660,360,80);
    state.pinkbox2.alpha = 1;
    state.isoAns2 = game.add.text(1005,660, "All three sides of this triangle \nare different.");
    state.isoAns2.fontWeight = 'normal';
    state.isoAns2.align = 'left';
    state.pinkbox2.endFill();
    state.isoAns2.addFontWeight('normal',0);
    ...
    state.pinkbox3.beginFill(0xF2C2B5, 1);
    state.pinkbox3.lineStyle(1, 0x000000,1);
    state.pinkbox3.drawRect(170,660, 360,80);
    state.pinkbox3.alpha = 1;
    state.isoAns3 = game.add.text(175,660, "This is an equilateral triangle. \nIt has three equal sides. ");
    state.isoAns3.fontWeight = 'normal';
    state.isoAns3.align = 'left';
    state.isoAns3.addFontWeight('normal',0);
    state.pinkbox3.endFill();
    ...
    state.pinkbox3a.drawRect(585,660, 360,80);
    state.pinkbox3a.alpha = 1;
    state.isoAns3a = game.add.text(590,660, "This is an equilateral triangle. \nIt has three equal sides. ");
    state.isoAns3a.fontWeight = 'normal';
    state.isoAns3a.align = 'left';
    state.isoAns3a.addFontWeight('normal',0);
    ...
    state.pinkbox4a.beginFill(0xF2C2B5, 1);
    state.pinkbox4a.lineStyle(1, 0x000000,1);
    state.pinkbox4a.drawRect(950,660, 360,80);
    state.pinkbox4a.alpha = 1;
    state.isoAns4a = game.add.text(955,660, "This is an equilateral triangle. \nIt has three equal sides. ");
    state.isoAns4a.fontWeight = 'normal';
    state.isoAns4a.align = 'left';
    state.isoAns4a.addFontWeight('normal',0);
    state.pinkbox4a.endFill();
    ...
    state.pinkbox4b.drawRect(175,660, 360,80);
    state.pinkbox4b.alpha = 1;
    state.isoAns4b = game.add.text(180,660, "This is an equilateral triangle. \nIt has three equal sides. ");
    state.isoAns4b.fontWeight = 'normal';
    state.isoAns4b.align = 'left';
    state.isoAns4b.addFontWeight('normal',0);
    ...
    state.pinkbox5i.endFill();
    state.isoAns5i.alpha = 0;
    state.pinkbox5i.alpha = 0;
    
    state.pinkbox5a = game.add.graphics(0,0);
    state.pinkbox5a.beginFill(0xF2C2B5, 1);
    ...
    state.pinkbox5a.endFill();
    state.isoAns5a.alpha = 0;
    state.pinkbox5a.alpha = 0;
    
    state.pinkbox5b = game.add.graphics(0,0);
    state.pinkbox5b.beginFill(0xF2C2B5, 1);
    ...
    state.pinkbox5b.endFill();
    state.isoAns5b.alpha = 0;
    state.pinkbox5b.alpha = 0;
    ...
    state.isoAns5c.align = 'left';
    state.isoAns5c.addFontWeight('normal',0);
    state.pinkbox5c.endFill();
    state.isoAns5c.alpha = 0;
    state.pinkbox5c.alpha = 0;
...
function rightangleAns(state) {
    ...
    state.pinkbox6.drawRect(760,720, 370,90);
    state.pinkbox6.alpha = 1;
    state.isoAns6 = game.add.text(780,730, "A right-angled triangle is a '\ntriangle with a 90\xB0 angle.");
    state.isoAns6.fontWeight = 'normal';
    state.isoAns6.align = 'left';
    state.isoAns6.addFontWeight('normal',0);
    ...
    state.pinkbox7.drawRect(600,660, 290,80);
    state.pinkbox7.alpha = 1;
    state.isoAns7 = game.add.text(605,663, "This triangle does not  \nhave a 90\xB0 angle.");
    state.isoAns7.fontWeight = 'normal';
    state.isoAns7.align = 'left';
    state.isoAns7.addFontWeight('normal',0);
    state.pinkbox7.endFill();
    state.isoAns7.alpha = 0;
    state.pinkbox7.alpha = 0;
    
        
    state.pinkbox7i = game.add.graphics(0,0);
    state.pinkbox7i.beginFill(0xF2C2B5, 1);
    state.pinkbox7i.lineStyle(1, 0x000000,1);
    state.pinkbox7i.drawRect(950,660, 290,80);
    state.pinkbox7i.alpha = 1;
    state.isoAns7i = game.add.text(955,663, "This triangle does not  \nhave a 90\xB0 angle.");
    state.isoAns7i.fontWeight = 'normal';
    state.isoAns7i.align = 'left';
    state.isoAns7i.addFontWeight('normal',0);
    state.pinkbox7i.endFill();
    state.isoAns7i.alpha = 0;
    state.pinkbox7i.alpha = 0;
    
     state.pinkbox7a = game.add.graphics(0,0);
    state.pinkbox7a.beginFill(0xF2C2B5, 1);
    state.pinkbox7a.lineStyle(1, 0x000000,1);
    state.pinkbox7a.drawRect(150,660, 365,80);
    state.pinkbox7a.alpha = 1;
    state.isoAns7a = game.add.text(155,660, "This is a right-angled triangle. \nIt has a 90\xB0 angle.");
    state.isoAns7a.fontWeight = 'normal';
    state.isoAns7a.align = 'left';
    state.isoAns7a.addFontWeight('normal',0);
    ...
    state.pinkbox8a.drawRect(950,660, 270,80);
    state.pinkbox8a.alpha = 1;
    state.isoAns8a = game.add.text(955,660, "This triangle does not  \nhave a 90\xB0 angle.");
    state.isoAns8a.fontWeight = 'normal';
    state.isoAns8a.align = 'left';
    state.isoAns8a.addFontWeight('normal',0);
    ...
    state.pinkbox8b.drawRect(250,660, 270,80);
    state.pinkbox8b.alpha = 1;
    state.isoAns8b = game.add.text(255,660, "This triangle does not  \nhave a 90\xB0 angle.");
    state.isoAns8b.fontWeight = 'normal';
    state.isoAns8b.align = 'left';
    state.isoAns8b.addFontWeight('normal',0);
    ...
    state.pinkbox8c.drawRect(565,660, 350,80);
    state.pinkbox8c.alpha = 1;
    state.isoAns8c = game.add.text(570,660, "This is a right-angled  \ntriangle. It has a 90\xB0 angle.");
    state.isoAns8c.fontWeight = 'normal';
    state.isoAns8c.align = 'left';
    state.isoAns8c.addFontWeight('normal',0);
