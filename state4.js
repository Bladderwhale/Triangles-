...
demo.state4.prototype = {
    ...
    create: function(){
        ...
        this.texts[6].text = "7 m";
        
        this.texts[7].position.setTo(880, 440);
        this.texts[7].text = "7 m";
        
        this.texts[8].position.setTo(680, 370);
        this.texts[8].text = "4 m";
        
        this.texts[9].position.setTo(950+50,400);
        this.texts[9].text = "3.4 m";
        
        this.texts[10].position.setTo(1125+50,325);
        this.texts[10].text = "6.0 m";
        
        this.texts[11].position.setTo(1135+50,475);
        this.texts[11].text = "7.4 m";
        ...
        this.btnPlay.events.onInputDown.add(function(){if (check>=2 && a == 1 && b ==1){this.highlight.alpha =1;this.pinkbox4a.alpha = 1;this.isoAns4a.alpha = 1; this.tick1.alpha = 1; this.tick2.alpha = 1; this.btnPlay.visible = false; this.btnNext.visible = true; this.texts[12].alpha = 1;this.texts[12].position.setTo(1160,805); this.texts[12].text = "Continue"; this.texts[3].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[4].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[6].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[7].setStyle({backgroundColor: 'rgba(255,255,0,1)'});} else if (check >=2 && c ==1 && b == 1){this.highlight.alpha =1;this.pinkbox2b.alpha =1; this.isoAns2b.alpha = 1;this.isoAns3b.alpha = 1; this.pinkbox3b.alpha = 1;this.confusedCheck++;this.boolTryAgain = true;this.cross1.alpha = 1; this.tick1.alpha = 0; this.tick2.alpha = 1; this.btnPlay.visible = false; this.btnNext.visible = true;this.texts[12].alpha = 1; this.texts[12].position.setTo(1160,805); this.texts[12].text = "Continue";this.texts[3].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[4].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[6].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[7].setStyle({backgroundColor: 'rgba(255,255,0,1)'});}else if (check >=2 && c ==1 && a == 1){this.highlight.alpha =1;this.isoAns2bb.alpha = 1; this.pinkbox2bb.alpha = 1;this.isoAns3b.alpha = 1; this.pinkbox3b.alpha = 1;this.confusedCheck++;this.boolTryAgain = true;this.cross1.alpha = 1; this.tick1.alpha = 1; this.tick2.alpha = 0; this.btnPlay.visible = false; this.btnNext.visible = true;this.texts[12].alpha = 1; this.texts[12].position.setTo(1160,805); this.texts[12].text = "Continue";this.texts[3].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[4].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[6].setStyle({backgroundColor: 'rgba(255,255,0,1)'});this.texts[7].setStyle({backgroundColor: 'rgba(255,255,0,1)'});}},this);
        ...
        this.boolTryAgain = false;
        k =0;this.k=0;check=0;this.check=0;game.state.start('state5');},this);
